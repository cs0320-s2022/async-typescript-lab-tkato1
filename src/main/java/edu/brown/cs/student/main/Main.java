...
public final class Main {
  ...
  private static class ResultsHandler implements Route {
    ...
    public String handle(Request req, Response res) {
      ...
      String rising = "";
      try {
        requested = new JSONObject(req.body());
        sun = requested.getString("sun");
        moon = requested.getString("moon");
        rising = requested.getString("rising");
      ...
      Map output = ImmutableMap.of("matches", matchList);
